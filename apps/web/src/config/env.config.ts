...
if (!parseResult.success) {
  console.error("❌ Invalid environment variables:", z.treeifyError(parseResult.error));
...
// export individual variables
 const ENV = envVars.VITE_ENV;
 const API_URL = envVars.VITE_API_URL;
const CLERK_PUBLISHABLE_KEY = envVars.VITE_CLERK_PUBLISHABLE_KEY;

export { ENV, API_URL, CLERK_PUBLISHABLE_KEY}
